...
buoyWalkingStds = [sh.f0p1.stdVels...
    sh.f0p2.stdVels...
    sh.f0p25.stdVels...
    sh.f0p35.stdVels...
    sh.f0p5.stdVels];
...
heavyWalkingStds  = [sh.f0p5.stdVels...
    sh.f0p75.stdVels...
    sh.f1p0.stdVels...
    sh.f1p25.stdVels...
    sh.f1p5.stdVels...
...
lgd = legend("Increased Buoyancy","Nominal Weight","Location","southeast")
fontsize(lgd,16,"points")
ylim([0 0.2])
xlim([0 4.5])
FormatPlot(gca)

figure('Name',"ComparingWalkingVelsWithSTD")
hold on
% errorbar(buoyWalkingFreqs,buoyWalkingVels,buoyWalkingStds,'b--','LineWidth',2)
errorbar(heavyWalkingFreqs,heavyWalkingVels,heavyWalkingStds,'k--','LineWidth',2)
xlabel("Gait Frequency (Hz)")
ylabel("Walking speed (m/s)")
% lgd = legend("Increased Buoyancy","Nominal Weight","Location","southeast")
fontsize(lgd,16,"points")
...
dataStruct.stdVels = std(avgVels);
