...
y_big_straight = [linspace(-0.134,-0.1,numel(t_crouch)) ...
    linspace(-0.1,-0.2,numel(t_jump))...
    linspace(-0.2,-0.134,numel(t_recover))];
...
x_small_angle_20 = [linspace(0.0,0.0,numel(t_crouch)) ...
    linspace(0.0,-0.16*sin(theta),numel(t_jump))...
    linspace(-0.16*sin(theta),0.0,numel(t_recover))];
y_small_angle_20 = [linspace(-0.134,-0.1,numel(t_crouch)) ...
    linspace(-0.1,-0.16*cos(theta),numel(t_jump))...
    linspace(-0.16*cos(theta),-0.134,numel(t_recover))];
...
x_big_angle_20 = [linspace(0.0,0.0,numel(t_crouch)) ...
    linspace(0.0,-0.16*sin(theta),numel(t_jump))...
    linspace(-0.16*sin(theta),0.0,numel(t_recover))];
y_big_angle_20 = [linspace(-0.134,-0.1,numel(t_crouch)) ...
    linspace(-0.1,-0.16*cos(theta),numel(t_jump))...
    linspace(-0.16*cos(theta),-0.134,numel(t_recover))];
